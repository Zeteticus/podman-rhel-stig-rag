#!/bin/bash
# create-textsearch-app.sh - Create the text search version of the STIG RAG app

echo "Creating text search STIG RAG application..."

cat > stig_app_no_chromadb.py << 'EOF'
#!/usr/bin/env python3
"""
...
echo "✅ Created stig_app_no_chromadb.py"
echo "📋 This version includes:"
echo "   • Fast text-based search"
echo "   • JSON upload functionality"
echo "   • Web interface"
echo "   • No ChromaDB dependency"
echo ""
echo "🚀 Run: chmod +x deploy-text-search.sh && ./deploy-text-search.sh"
